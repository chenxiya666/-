...
<meta name="keywords" content="表白网页在线制作,在线制作表白网站,表白网页,生日表白网站,阿狸表白网页,表白网,免费制作,表白网页生成器,2015,样式最多,情人节告白,520,七夕表白,怎么表白" />
<meta name="description" content="表白网www.9413520.com是国内专业提供免费表白服务的好站！免费的表白网页全部一键式生成，精美简约的表白模版，完全自定义内容。永久保存您的表白信息，记录您和TA的故事。我们的口号是： 为爱情提供免费助力！" />
	<title>阿狸表白网页自动生成程序 - 表白网www.9413520.com - 情人节,表白程序,表白源码,自动表白程序,表白网页制作</title>
	...
	<div class="flowtime">
		<div class="ft-section section-1" data-id="section-1">
			<div id="/section-1/page-1" class="ft-page page-1" data-id="page-1">
				...
				<p class="text2">按键盘 "↓" <span id="text-78" contenteditable="true">制作我的爱情告白</span></p>
				<p >修改方法：按 "↓"向下修改每一个图片上的文字为你所要表白的文字即可 （背景音乐最后一步更改）</p>
<p style="text-align:center;">不会修改的朋友请加QQ群<a target="_blank" href="http://shang.qq.com/wpa/qunwpa?idkey=851f68080cfaba53df030398eacd7bb23898290b213e89b7135626eaa364f715"><img border="0" src="http://pub.idqqimg.com/wpa/images/group.png" alt="情侣表白交流" title="情侣表白交流"></a>获取免费技术咨询服务</p>
			</div>
	...
	<div class="write-ok">
		<div class="write-box">
			<h2>还差一步即可生成表白页面</h2>
			<p id="write-mp3">音乐：<span id="text-music" contenteditable="true">请将自定义mp3音乐外链地址粘贴此处</p>
			<p><small><a href="http://www.9413520.com/sp.html" target="_blank">不会填写了？点击这里看一下教程吧！</a></small></p>
			<p id="write-url">自定义表白链接：<u>http://www.9413520.com/love/2015/</u><span id="text-href" contenteditable="true"><?php echo time(); ?></span><i></i><u>.html</u></p>
